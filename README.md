...
This repo produces and publishes portable Linux binary builds of ungoogled-chromium with support for Certificate Authority of Russian Ministry of Digital Development and Communications.
...
Otherwise, this is fully tracking [upstream](//github.com/ungoogled-software/ungoogled-chromium-portablelinux) packaging of ungoogled-chromium for Linux. No other changes.
...
Builds are available as [Releases](//github.com/giantplaceholder/ungoogled-chromium-portablelinux/releases). 

Just download .AppImage, make it executable and run. Binaries are built against Debian Trixie environment, so should work on Ubuntu and other distros from this era.
